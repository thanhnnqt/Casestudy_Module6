                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-md-5">
                                            <div className="d-flex align-items-center justify-content-between mb-2">
                                                <div className="text-center">
                                                    ...
                                                    <div
                                                        className="small text-muted">{booking.flight?.departureAirport?.city}</div>
                                                </div>
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    <div
                                                        className="small text-muted">{booking.flight?.arrivalAirport?.city}</div>
                                                </div>
                                            </div>
                                            <div className="text-center small text-muted">
                                                Ngày khởi
                                                hành: {new Date(booking.flight?.departureTime).toLocaleDateString('vi-VN')}
                                            </div>
                                        </div>

                                        {/* Phân tách giữa chuyến về (nếu có) */}
                                        <div
                                            className="col-md-1 d-none d-md-block text-center border-start border-end py-3">
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <div className="mt-3 small">
                                                <p className="mb-1"><i className="bi bi-person me-2"></i>Hành
                                                    khách: <strong>{booking.contactName}</strong></p>
                                                <p className="mb-0 text-muted"><i
                                                    className="bi bi-calendar-event me-2"></i>Ngày
                                                    đặt: {formatDate(booking.bookingDate)}</p>
                                            </div>
                                        </div>
