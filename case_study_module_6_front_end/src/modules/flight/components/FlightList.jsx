...
const FlightList = () => {
    ...
    // --- STATE VIEW MODE: 'card' hoặc 'table' ---
    ...
    const renderSortIndex = (key) => {
        ...
        return index !== -1 && sortConfig.length > 1 ?
            <sup className="ms-1 text-warning fw-bold">{index + 1}</sup> : null;
    };
    ...
    return (
        <div className="flight-list-container">
            ...
            <div className="sky-container">
                <i className="bi bi-cloud-fill cloud"
                   style={{top: '10%', fontSize: '120px', animationDuration: '45s', opacity: 0.4}}></i>
                <i className="bi bi-cloud-fill cloud" style={{
                    top: '30%',
                    fontSize: '80px',
            ...
            <div className={`sidebar ${sidebarCollapsed ? 'collapsed' : ''}`} id="sidebar">
                <div className="d-flex justify-content-between align-items-start w-100">
                    ...
                    <button className="btn-toggle" onClick={() => setSidebarCollapsed(!sidebarCollapsed)}><i
                        className="bi bi-list"></i></button>
                </div>
                <div className="nav flex-column">
                    <a href="#" className="nav-link active"><i className="bi bi-grid-1x2-fill"></i>
                        <span>Tổng quan</span></a>
                    <a href="#" className="nav-link"><i className="bi bi-ticket-perforated-fill"></i>
                        <span>Đặt chỗ</span></a>
                </div>
            ...
            <div className="main">
                ...
                <div className="glass-card p-3 mb-4" style={{position: 'relative', zIndex: 10}}>
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="price-range-container">
                                <div className="d-flex justify-content-between mb-1">
                                    <span
                                        className="text-dark fw-bold small">{(priceRange.min / 1000000).toFixed(1)}tr</span>
                                    <span
                                ...
                                <div className="range-slider-wrapper">
                                    ...
                                    <input type="range" min="0" max="20000000" step="500000" value={priceRange.max}
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="date-range-picker-container" ref={datePickerRef}>
                                <div
                                    ...
                                    <span>{formatDateDisplay()}</span><i className="bi bi-calendar-range"></i>
                                </div>
                                {showDatePicker && (
                    ...
                    <div className="row g-2 align-items-end">
                        ...
                        <div className="col-md-3"><label className="form-label text-muted small fw-bold">NƠI ĐẾN</label><input
                            name="destination" className="form-control custom-input" placeholder="Nơi đến"
                            onChange={handleFilterChange} list="cityOpt"/></div>
                ...
                <div className="sort-toolbar shadow-sm d-flex justify-content-between">
                    ...
                    <div className="view-mode-group">
                        <button className={`btn btn-view-mode ${viewMode === 'table' ? 'active' : ''}`}
                                onClick={() => setViewMode('table')} title="Dạng bảng">
                ...
                <div className="flight-list-wrapper">
                    <div className="d-flex justify-content-between align-items-center mb-3 px-2">
                        <h6 className="fw-bold mb-0 text-secondary" style={{fontSize: '0.95rem'}}>Tìm
                            thấy {flights.length} chuyến bay</h6>
                                            ...
                                            <div className="d-flex align-items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="d-flex gap-2 align-items-center mt-1">
                                                        ...
                                                        <span
                                                            className="text-muted small fw-bold">#{f.aircraft.airline.code}{f.flightNumber}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="d-flex flex-column h-100 justify-content-center">
                                                    ...
                                                    {f.seatDetails && f.seatDetails.length > 0 ? (
                                                        f.seatDetails.map((seat) => (
                                                            <div key={seat.id} className="seat-detail-row">
                                                                <span
                                                                    className="seat-class-name small text-uppercase">{seat.seatClass === 'FIRST_CLASS' ? 'First' : seat.seatClass}</span>
                                                                <div className="text-end">
                                                                    <span
                                                                        className="seat-price d-block">{seat.price.toLocaleString()}đ</span>
                                                                    <span
                                                                        className="seat-avail">Còn {seat.availableSeats}</span>
                                                                </div>
                                                            </div>
                                                        ))
                                                ...
                                                {f.status !== 'CANCELLED' && f.status !== 'COMPLETED' && (
                                                    <div className="text-end mt-2">
                                                        <Link to={`/flights/edit/${f.id}`} className="btn-edit-card"><i
                                                            className="bi bi-pencil-square me-1"></i> Sửa</Link>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                            ...
                                            <tr key={f.id}
                                                ...
                                                <td className="ps-4">
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src={f.aircraft.airline.logoUrl} alt="Logo" style={{
                                                            width: '30px',
                                                            height: '30px',
                                                            objectFit: 'contain'
                                                        }}/>
